...
// Use relative `/api/*` in production (Vercel). For local dev you can still run the Flask
// server on 127.0.0.1:5000 and the app will use it automatically.
...
function showOfflineBanner(message) {
  ...
  banner.innerHTML = `
    ...
    <div style="background:rgba(255,107,53,0.08);border:1px solid rgba(255,107,53,0.25);border-radius:12px;
      ...
      pip install flask flask-cors groq<br>
      python app.py
    </div>
